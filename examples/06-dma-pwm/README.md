...
The period of the timer is 256 �s, which is almost 4 kHz. ECG frequencies 
...
Most of the `Setup()` functions only configure registers — clock gating is
...
The resistor value is a **4k7** and the capacitor is **1�F**.
